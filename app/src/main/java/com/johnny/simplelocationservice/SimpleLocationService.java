...
public class SimpleLocationService extends Service implements LocationSource, AMapLocationListener {
    ...
    private void initLoc() {
        ...
        mLocationOption.setInterval(300000); //间隔时间
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ...
        if(aMapLocation != null){
            ...
            if(aMapLocation.getErrorCode() == 0){
                ...
                if(location.getLatitude() != lastLat || location.getLongitude() != lastLon || (location.getTime() - lastTime > scheduleTime)){
